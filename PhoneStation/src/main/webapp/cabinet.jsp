...
<div class="container-fluid">
	<div class="row-fluid">
		<div class="well span2">
			<!--Sidebar content-->
			<c:import url="jsp/user/leftMenu.jsp" />
		</div>
		<div class="well span10">
			<!--Body content-->
			<c:choose>
    			<c:when test="${param.page == null}">
					<c:import url="jsp/user/services.jsp" />
				</c:when>
				<c:when test="${param.page == \"dialogues\"}">
					<c:import url="jsp/user/dialogues.jsp" />
				</c:when>
				<c:when test="${param.page == \"purse\"}">
					<c:import url="jsp/user/purse.jsp" />
				</c:when>
				<c:otherwise>
					404
				</c:otherwise>
